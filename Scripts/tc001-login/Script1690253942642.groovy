...
WebUI.setText(findTestObject('Object Repository/tc003-warehouseassetsave/input_Username or Email_email'), 
    'komaruddin.skom@gmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/tc003-warehouseassetsave/input_Password_password'), 
    'iGDxf8hSRT4=')

WebUI.click(findTestObject('Object Repository/tc003-warehouseassetsave/button_Sign In'))

WebUI.click(findTestObject('Object Repository/tc003-warehouseassetsave/h4_Dashboard'))
